 ...
 * \pre p_nom non vide et que des charactere
 * \pre p_prenom non vide et que des charactere
 * \pre nom et prenom valide
 * \pre  numero de telephone valide
 * \post m_prenom==p_prenom
 * \post m_nom==p_nom
 * \post m_telephone==p_telephone
 * \post m_datedenaissance==p_datedenaissance
 */

hockey::Personne::Personne (const std::string &p_nom,const std::string &p_prenom,
                            const util::Date &p_dateNaissance,
                            const std::string &p_telephone):m_nom(p_nom),m_prenom(p_prenom),
 ...
 */
std::string hockey::Personne::reqPersonneFormate ()const{
 ...
 * cas valide:le nom ,le prenom et la date de naissance doit etre valide
 */
